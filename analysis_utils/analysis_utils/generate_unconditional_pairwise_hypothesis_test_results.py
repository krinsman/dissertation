from simulations.unconditional_local_chi2_cpm import get_all_unconditional_pairwise_pearson_categorical_divergences_and_p_values
import time
import datetime
import numpy as np
...
def get_unconditional_pairwise_results(simulation_filename, simulation_basename, number_simulations, variable_name='droplets'):
    ...
    results_filename = 'unconditional_pairwise_results/{}_results.{}.npz'.format(simulation_basename, prettify(simulation_number))
    ...
    try:
        ...
        divergences, pvals, difference_vectors = get_all_unconditional_pairwise_pearson_categorical_divergences_and_p_values(droplets, frequencies, rate=rate, differences=True)
